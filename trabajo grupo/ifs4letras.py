...
class IFS:
	def __init__(self):
		self.mat = [
						...
						[0.08,0,0,0.1,-6,3.1,0.03225806452], # J bot

						[0.1,0,0,0.1,-1.8,8,0.03225806452], #G top
						[0,0.065,-0.24,0,-2.6,6.1,0.03225806452], #G v l
						[0.1,0,0,0.1,-1.8,3,0.03225806452],	#G bot
						[0, 0.06, -0.1, 0, -1.1, 4, 0.03225806452], #G v r
						[0.06, 0, 0, 0.06, -1, 5, 0.03225806452],# G v mid

						[0.1, 0, 0, 0.1, 2.3, 8, 0.03225806452], # A top
						[0,0.065,-0.32,0,1.4,6,0.03225806452], # A v l
						[0,0.065,-0.32,0,3.0,6,0.03225806452], # A vertical right
						[0.05, 0, 0, 0.06, 2.5, 5, 0.03225806452], # A mid

						[0.1,0,0,0.1,6.3,8,0.03225806452],#R top
						[0,0.065,-0.32,0,5.4,6.0,0.03225806452],#R v left
						[0,0.065,-0.16,0,6.7,7.0,0.03225806452],#R v r
						[0.06, 0, 0, 0.06, 6.5, 5, 0.03225806452],#R mid

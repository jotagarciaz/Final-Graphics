...
_recipes_pil_prescript(['IptcImagePlugin', 'TiffImagePlugin', 'WebPImagePlugin', 'PngImagePlugin', 'JpegImagePlugin', 'EpsImagePlugin', 'SunImagePlugin', 'FpxImagePlugin', 'MpoImagePlugin', 'XVThumbImagePlugin', 'GbrImagePlugin', 'XbmImagePlugin', 'GifImagePlugin', 'PcdImagePlugin', 'DcxImagePlugin', 'XpmImagePlugin', 'WmfImagePlugin', 'Jpeg2KImagePlugin', 'SgiImagePlugin', 'Hdf5StubImagePlugin', 'BufrStubImagePlugin', 'FliImagePlugin', 'IcnsImagePlugin', 'FtexImagePlugin', 'SpiderImagePlugin', 'MicImagePlugin', 'ImtImagePlugin', 'TgaImagePlugin', 'BlpImagePlugin', 'PixarImagePlugin', 'PsdImagePlugin', 'DdsImagePlugin', 'ImImagePlugin', 'IcoImagePlugin', 'CurImagePlugin', 'McIdasImagePlugin', 'MpegImagePlugin', 'GribStubImagePlugin', 'MspImagePlugin', 'PdfImagePlugin', 'PalmImagePlugin', 'BmpImagePlugin', 'FitsStubImagePlugin', 'PpmImagePlugin', 'PcxImagePlugin'])
...
DEFAULT_SCRIPT='FraseFractal.py'
SCRIPT_MAP={}
_run()
